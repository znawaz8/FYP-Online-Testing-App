<?php $__env->startSection('table_view'); ?>
   <?php echo $__env->make('errors.list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo Form::model($category, ['action' => ['CategoryController@patchEdit', $category->id], 'method'=>'PATCH', 'class'=>'form-horizontal']); ?>
   ...
   <div class="form-group">
       <div class="col-sm-offset-2 col-sm-10">
            <?php echo Form::submit('Update category', ['class'=>'btn btn-primary']); ?>
