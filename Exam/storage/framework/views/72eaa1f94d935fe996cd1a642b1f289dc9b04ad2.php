        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="<?php echo e(url('/home')); ?>" class="dropdown-toggle"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Modules  <span class="caret"></span></a>
                        <ul class="dropdown-menu" id="manager-menu">
                            <li><span class="glyphicon glyphicon-cog"></span> <a href="<?php echo e(action('CategoryController@getIndex')); ?>">Manager Category</a></li>
